  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      function ShowcasePanel() {
        ...
        return h('div', null,
          h('div', { className: 'sc-mask', onClick: () => setState({ showcaseOpen: false }) }),
